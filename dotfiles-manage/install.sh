...
if command -v pacman -Syyu >/dev/null; then
	...
	sudo pacman -S nerd-fonts-jetbrains-mono fish starship waybar rofi $hyprland hyprpaper alacritty zoxide fzf grim dunst thefuck exa helix atuin --noconfirm
